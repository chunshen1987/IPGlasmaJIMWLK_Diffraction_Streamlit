...
class EmulatorBAND:
    ...
    def testEmulatorErrors(self, number_test_points=1):
        ...
        #random_indices = np.random.choice(range(self.nev), number_test_points, replace=False)
        ...
        if self.logTrafo_ and not self.exp_and_cov_diag_: # transform back to original space
